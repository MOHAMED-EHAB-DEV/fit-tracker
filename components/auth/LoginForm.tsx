...
import { Dumbbell, Lock, Mail, ArrowRight, Loader2, AlertCircle, Eye, EyeOff } from "lucide-react";
  ...
  return (
    <div className="w-full max-w-md p-6 sm:p-8 rounded-2xl bg-zinc-900/80 border border-zinc-800/80 backdrop-blur-xl shadow-2xl shadow-emerald-950/20 text-zinc-100">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label htmlFor="login-email" className="block text-xs font-semibold uppercase tracking-wider text-zinc-400 mb-1.5 select-none">
            Email Address
          </label>
          <div className="relative">
            ...
            <input
              ...
              required
              autoComplete="email"
              className="w-full pl-11 pr-4 py-3 min-h-11 bg-zinc-800/60 border border-zinc-700/60 rounded-xl text-white placeholder-zinc-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 transition"
            />
          </div>
        </div>

        <div>
          <label htmlFor="login-password" className="block text-xs font-semibold uppercase tracking-wider text-zinc-400 mb-1.5 select-none">
            Password
          </label>
          <div className="relative">
