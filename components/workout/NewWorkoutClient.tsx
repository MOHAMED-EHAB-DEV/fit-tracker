    ...
    <div className="max-w-xl mx-auto space-y-6 pt-4">
      <div className="p-6 md:p-8 rounded-3xl bg-zinc-900/80 border border-zinc-800/80 space-y-6">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-2xl bg-linear-to-tr from-emerald-500 to-teal-400 p-0.5 shadow-lg shadow-emerald-500/20 flex items-center justify-center">
            <div className="w-full h-full bg-zinc-950 rounded-[14px] flex items-center justify-center">
              <Dumbbell className="w-6 h-6 text-emerald-400" aria-hidden="true" />
            </div>
          </div>
          <div>
        ...
        <form onSubmit={handleCreateWorkoutSheet} className="space-y-5">
          ...
          <div>
            <label className="text-xs font-semibold uppercase tracking-wider text-zinc-400 mb-2 flex items-center gap-1.5 select-none">
          ...
          {/* Workout Name */}
          <div>
            <label htmlFor="new-workout-name" className="block text-xs font-semibold uppercase tracking-wider text-zinc-400 mb-1.5 select-none">
        ...
        <div className="pt-4 border-t border-zinc-800 flex items-center justify-between">
          ...
          <Link
            ...
            className="flex items-center gap-1.5 text-xs font-semibold text-emerald-400 hover:text-emerald-300 transition focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 rounded"
          >
...
export default NewWorkoutClient;
