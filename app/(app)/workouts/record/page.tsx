  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto pb-16">
      ...
      <div ref={headerRef}>
        <header className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link
              href="/"
              className="p-2.5 rounded-2xl bg-zinc-900 border border-zinc-800 text-zinc-400 hover:text-white transition"
            >
          ...
          <button
            ...
            className="px-5 py-3 rounded-2xl bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-zinc-950 font-black text-xs shadow-lg shadow-emerald-500/20 transition active:scale-95 flex items-center gap-2 disabled:opacity-50 cursor-pointer"
          >
            {isSaving ? (
      ...
      <div className="p-5 sm:p-6 rounded-3xl bg-zinc-900/80 border border-zinc-800/80 space-y-4">
        ...
        <div>
          <label className="text-[10px] font-bold uppercase tracking-wider text-zinc-400 mb-2 flex items-center gap-1.5">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-zinc-950 border border-zinc-800 rounded-2xl text-white font-extrabold text-base focus:outline-none focus:ring-2 focus:ring-emerald-500/50"
          />
        </div>

        {/* Summary Stats */}
        <div className="flex items-center justify-between pt-2 border-t border-zinc-800/60 text-xs text-zinc-400">
          <span>Exercises: <strong className="text-white">{exercises.length}</strong></span>
          <span>Lifted Volume: <strong className="text-emerald-400">{totalVolume.toLocaleString()} kg</strong></span>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {exercises.length === 0 ? (
          <div className="text-center py-12 border border-dashed border-zinc-800 rounded-3xl space-y-3 bg-zinc-900/40">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-2xl bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-bold text-xs shadow-md shadow-emerald-500/20 transition active:scale-95"
            >
            ...
            >
              ...
              <div className="flex items-center justify-between gap-3 flex-wrap">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <Flame className={`w-3.5 h-3.5 ${isWarmup ? "text-amber-400 fill-amber-400/40" : "text-zinc-500"}`} />
        ...
        {exercises.length > 0 && (
          <button
            type="button"
            onClick={() => setShowSearch(true)}
            className="w-full py-3.5 rounded-3xl bg-zinc-900 hover:bg-zinc-800/80 text-emerald-400 text-xs font-bold border border-zinc-800 transition flex items-center justify-center gap-2 shadow-sm"
          >
            <Plus className="w-4 h-4" />
