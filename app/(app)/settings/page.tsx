    ...
    <div className="max-w-2xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-zinc-950 border border-zinc-700/60 rounded-xl text-white text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/50"
              />
            </div>
          ...
          <div className="p-5 rounded-2xl bg-zinc-900/40 border border-zinc-800/60">
            ...
            <div className="grid grid-cols-3 gap-3 text-center">
              <div className="p-3 rounded-xl bg-zinc-950/60 border border-zinc-800">
                ...
                <span className="text-lg font-bold text-white block mt-0.5">{user.computed.bmr || "—"}</span>
              ...
              <div className="p-3 rounded-xl bg-zinc-950/60 border border-zinc-800">
                ...
                <span className="text-lg font-bold text-orange-300 block mt-0.5">{user.computed.tdee || "—"}</span>
                <span className="text-[10px] text-zinc-500">kcal/day</span>
              </div>
              <div className="p-3 rounded-xl bg-zinc-950/60 border border-zinc-800">
                <span className="text-[10px] text-emerald-400 uppercase block font-semibold">Optimal Protein</span>
                <span className="text-lg font-bold text-emerald-300 block mt-0.5">{user.computed.proteinTargetG || "—"}g</span>
      ...
      <div className="p-6 rounded-2xl bg-zinc-900/80 border border-zinc-800/80 space-y-3">
        ...
        <p className="text-xs text-zinc-400">
          Token Version: <strong className="text-zinc-200">{user?.tokenVersion || 0}</strong>. If you suspect any unauthorized access, you can force log out all other devices immediately.
        </p>
        <button
          type="button"
