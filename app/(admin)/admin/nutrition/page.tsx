...
export default function AdminNutritionPage() {
  ...
  const columns: Column<PlanRow>[] = [
    ...
    },
    {
      key: "targetProteinG",
      label: "Protein",
      render: (row) => <span className="text-xs text-zinc-400 font-medium">{row.targetProteinG}g</span>,
    },
    {
      key: "meals",
      label: "Meals",
      render: (row) => (
        <div className="flex items-center gap-1.5 text-xs text-zinc-400">
          <BookOpen className="w-3.5 h-3.5 text-zinc-500" /> {row.meals?.length ?? 0}
        </div>
      ),
    },
    {
      ...
      render: (row) => (
        <div className="flex items-center gap-1.5 text-xs text-zinc-400">
          <Users className="w-3.5 h-3.5 text-zinc-500" /> {row.assignedTo?.length ?? 0} users
        </div>
      ),
    },
    {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-zinc-400 text-sm mt-1">{pagination.total} plans created</p>
        </div>
        <Button
