      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <section>
              <h2 className="text-xs font-bold uppercase tracking-widest text-zinc-600 mb-3 flex items-center gap-2">
                <UtensilsCrossed className="w-3.5 h-3.5" /> Nutrition
              </h2>
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                <StatsCard
                  label="Meals Logged"
          ...
          <section>
            <h2 className="text-xs font-bold uppercase tracking-widest text-zinc-600 mb-3 flex items-center gap-2">
              <Dumbbell className="w-3.5 h-3.5" /> Exercise Catalog
            </h2>
      ...
      <section>
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-xs font-bold uppercase tracking-widest text-zinc-600 flex items-center gap-2">
            <Users className="w-3.5 h-3.5" /> Recently Joined
          </h2>
          <a href="/admin/users" className="text-xs text-violet-400 hover:text-violet-300 transition font-medium">
            View all →
          </a>
        </div>
